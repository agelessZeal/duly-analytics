...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://duly.com/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://duly.com/#/swap?inputCurrency=${
...
export function getMiningPoolLink(token0Address) {
  return `https://duly.com/#/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://duly.com/#/uni'
  if (!linkVariable) {
