...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#3f48cc' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#3f48cc',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#3f48cc',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#3f48cc',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #3f48cc30 0%, #fff 0%)`,
})
